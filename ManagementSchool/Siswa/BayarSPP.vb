Public Class BayarSPP
    ...
    Private Sub refreshData()
        ...
        Dim sql As String = "SELECT tbl_det_spp.bulan as bulan, tbl_det_spp.tanggal_bayar as tanggal_bayar, tbl_det_spp.jumlah_bayar as jumlah_bayar ,tbl_spp.tahun_ajaran as tahun_ajaran FROM tbl_spp INNER JOIN tbl_det_spp ON tbl_spp.id_spp = tbl_det_spp.id_spp  WHERE tbl_spp.nis = '" + id_siswa + "'"
